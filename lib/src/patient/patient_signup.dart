...
class _PatientSignupPageState extends State<PatientSignupPage> {
  ...
  void _submitForm() {
    if (_formKey.currentState!.validate()) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text('Registration successful for ${_nameController.text}. Redirecting to Dashboard...'),
        ),
      );
              ...
              Form(
                ...
                child: Column(
                  children: [
                    ...
                    // Student/Staff ID (Assuming all users have an ID)
                    TextFormField(
                      controller: _studentIdController,
                      keyboardType: TextInputType.text,
                      decoration: _inputDecoration('Student/Staff ID', Icons.badge),
                    ...
                    TextFormField(
                      ...
                      decoration: _inputDecoration('Session (e.g., 2022-2023)', Icons.calendar_month),
                    ),
                    const SizedBox(height: 15),
                    ...
                    TextFormField(
                      ...
                      decoration: _inputDecoration('Blood Group (e.g., O+)', Icons.bloodtype),
                    ),
                    const SizedBox(height: 15),
                    ...
                    TextFormField(
                      ...
                      decoration: _inputDecoration('Allergies (Optional)', Icons.warning),
                    ),
                  ...
                  TextButton(
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => const HomePage(), // Assuming HomePage is the login page
                        ),
                      );
                    },
                    child: Text('Log In', style: TextStyle(color: kPrimaryColor, fontWeight: FontWeight.bold, fontSize: 16)),
                  ),
                ],
              ),
            ],
