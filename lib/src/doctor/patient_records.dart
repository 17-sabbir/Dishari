...
import 'package:spl2/src/doctor/prescription_page.dart'; // Ensure this exists
          ...
          ElevatedButton(
            onPressed: () {
              ...
              ScaffoldMessenger.of(context).showSnackBar(
                SnackBar(content: Text("New record created for ${nameController.text}")),
              );
            ...
            child: const Text("Create & Go to Prescription",
            ...
            Padding(
              ...
              child: Column(
                children: [
                  ...
                  const SizedBox(height: 10),
                  Text('No Record Found for "$query"',
                  ...
                  return Card(
                    ...
                    child: ListTile(
                      ...
                      subtitle: Column(
                        ...
                        children: [
                          Text('ID: ${patient['id']}'),
                          Text('${patient['department']} - ${patient['session']}'),
                        ],
                      ),
        ...
        children: [
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text('ID: ${patient['id']}', style: const TextStyle(color: Colors.grey)),
                  ],
                ),
              ),
            ],
            ...
            child: ListView(
              children: const [
                ListTile(
                  ...
                  subtitle: Text('Prescribed: Paracetamol, Antibiotics\nDate: 2024-01-15'),
                ),
                ListTile(
                  leading: Icon(Icons.medical_services, color: Colors.orange),
                  title: Text('Stomach Infection'),
                  subtitle: Text('Prescribed: Antacids, Antibiotics\nDate: 2023-12-10'),
                ),
              ],
            ),
          ),
          ...
          SizedBox(
            ...
            child: ElevatedButton(
              ...
              child: const Text('Create Prescription', style: TextStyle(color: Colors.white, fontSize: 16)),
            ),
          ),
        ],
      ),
