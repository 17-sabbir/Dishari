...
import 'package:spl2/src/doctor/reports_page.dart';
...
import 'package:spl2/src/lab_test/lab_staff_panel.dart';
import 'package:spl2/src/lab_test/lab_tester_profile.dart';
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        '/doctor-reports': (context) => const ReportsPage(),
        ...
        '/lab-panel': (context) => const LabStaffPanel(),
